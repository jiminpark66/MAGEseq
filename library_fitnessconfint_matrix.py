...
def main(lib_name,Library,AA_start,AA_end):
	...
	with open(lib_name + "_library_fitness_conf_int.csv","r") as f:
	...
	if n == 3:
		...
		DFF.to_csv(lib_name + "_fitness_confint_matrix_unformat.csv")
	...
	DFF.to_csv(lib_name + "_fitness_confint_matrix.csv")
